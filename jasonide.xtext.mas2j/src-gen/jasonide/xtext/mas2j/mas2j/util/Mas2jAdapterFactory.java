...
public class Mas2jAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected Mas2jSwitch<Adapter> modelSwitch =
    new Mas2jSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseMindinspector(Mindinspector object)
      {
        return createMindinspectorAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link jasonide.xtext.mas2j.mas2j.Beliefs <em>Beliefs</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link jasonide.xtext.mas2j.mas2j.Goals <em>Goals</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link jasonide.xtext.mas2j.mas2j.Mindinspector <em>Mindinspector</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createMindinspectorAdapter()
  {
    return null;
  }
