...
public class Mas2jSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        Beliefs beliefs = (Beliefs)theEObject;
        T result = caseBeliefs(beliefs);
        if (result == null) result = caseOption(beliefs);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case Mas2jPackage.GOALS:
      {
        ...
        if (result == null) result = caseOption(goals);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case Mas2jPackage.MINDINSPECTOR:
      {
        Mindinspector mindinspector = (Mindinspector)theEObject;
        T result = caseMindinspector(mindinspector);
        if (result == null) result = caseOption(mindinspector);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Beliefs</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Beliefs</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseBeliefs(Beliefs object)
  {
    return null;
  }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Mindinspector</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Mindinspector</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseMindinspector(Mindinspector object)
  {
    return null;
  }
