 ...
 * <ul>
 *   <li>{@link jasonide.xtext.mas2j.mas2j.impl.DirectivesImpl#getDirectives <em>Directives</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DirectivesImpl extends MinimalEObjectImpl.Container implements Directives
{
  ...
  {
    return Mas2jPackage.Literals.DIRECTIVES;
  }
  ...
  public EList<Directive> getDirectives()
  {
    if (directives == null)
    {
      directives = new EObjectContainmentEList<Directive>(Directive.class, this, Mas2jPackage.DIRECTIVES__DIRECTIVES);
    }
    return directives;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Mas2jPackage.DIRECTIVES__DIRECTIVES:
