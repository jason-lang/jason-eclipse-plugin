 ...
 * <ul>
 *   <li>{@link jasonide.xtext.mas2j.mas2j.impl.InstancesImpl#getInstances <em>Instances</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InstancesImpl extends MinimalEObjectImpl.Container implements Instances
{
  ...
  {
    return Mas2jPackage.Literals.INSTANCES;
  }
  ...
  public void setInstances(int newInstances)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Mas2jPackage.INSTANCES__INSTANCES, oldInstances, instances));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case Mas2jPackage.INSTANCES__INSTANCES:
        return getInstances();
    }
