...
public class Mas2jPackageImpl extends EPackageImpl implements Mas2jPackage
{
   ...
   * @generated
   */
  private EClass beliefsEClass = null;
   ...
   * @generated
   */
  private EClass mindinspectorEClass = null;
   ...
   * @generated
   */
  public EClass getBeliefs()
  {
    return beliefsEClass;
  }
   ...
   * @generated
   */
  public EAttribute getBeliefs_Val()
  {
    return (EAttribute)beliefsEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EAttribute getGoals_Val()
  {
   ...
   * @generated
   */
  public EClass getMindinspector()
  {
    return mindinspectorEClass;
  }
   ...
   * @generated
   */
  public EAttribute getMindinspector_Val()
  {
    return (EAttribute)mindinspectorEClass.getEStructuralFeatures().get(0);
  }
  ...
  public void createPackageContents()
  {
    ...
    beliefsEClass = createEClass(BELIEFS);
    createEAttribute(beliefsEClass, BELIEFS__VAL);

    goalsEClass = createEClass(GOALS);
    createEAttribute(goalsEClass, GOALS__VAL);

    mindinspectorEClass = createEClass(MINDINSPECTOR);
    createEAttribute(mindinspectorEClass, MINDINSPECTOR__VAL);
  ...
  public void initializePackageContents()
  {
    ...
    beliefsEClass.getESuperTypes().add(this.getOption());
    goalsEClass.getESuperTypes().add(this.getOption());
    mindinspectorEClass.getESuperTypes().add(this.getOption());
    ...
    initEClass(beliefsEClass, Beliefs.class, "Beliefs", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getBeliefs_Val(), ecorePackage.getEString(), "val", null, 0, 1, Beliefs.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(goalsEClass, Goals.class, "Goals", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getGoals_Val(), ecorePackage.getEString(), "val", null, 0, 1, Goals.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(mindinspectorEClass, Mindinspector.class, "Mindinspector", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getMindinspector_Val(), ecorePackage.getEString(), "val", null, 0, 1, Mindinspector.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
