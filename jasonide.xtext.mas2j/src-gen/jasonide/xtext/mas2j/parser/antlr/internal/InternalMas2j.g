...
@after {
	...
	(
		...
		{
			$current = $this_Beliefs_5.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_Mindinspector_7.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
// Entry rule entryRuleBeliefs
entryRuleBeliefs returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getBeliefsRule()); }
	iv_ruleBeliefs=ruleBeliefs
	{ $current=$iv_ruleBeliefs.current; }
	EOF;

// Rule Beliefs
ruleBeliefs returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
// Entry rule entryRuleMindinspector
entryRuleMindinspector returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getMindinspectorRule()); }
	iv_ruleMindinspector=ruleMindinspector
	{ $current=$iv_ruleMindinspector.current; }
	EOF;

// Rule Mindinspector
ruleMindinspector returns [EObject current=null]
@init {
	enterRule();
}
@after {
