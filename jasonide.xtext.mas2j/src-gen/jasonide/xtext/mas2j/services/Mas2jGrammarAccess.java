...
public class Mas2jGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class BeliefsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "Beliefs");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MindinspectorElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "Mindinspector");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	private BeliefsElements pBeliefs;
	private GoalsElements pGoals;
	private MindinspectorElements pMindinspector;
	...
	public BeliefsElements getBeliefsAccess() {
		return (pBeliefs != null) ? pBeliefs : (pBeliefs = new BeliefsElements());
	}
	...
	public MindinspectorElements getMindinspectorAccess() {
		return (pMindinspector != null) ? pMindinspector : (pMindinspector = new MindinspectorElements());
	}
