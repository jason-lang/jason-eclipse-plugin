 ...
 *   <li>{@link jasonide.xtext.asl.asl.impl.StmtIFImpl#getLog_expr <em>Log expr</em>}</li>
 *   <li>{@link jasonide.xtext.asl.asl.impl.StmtIFImpl#getPlan_term <em>Plan term</em>}</li>
 *   <li>{@link jasonide.xtext.asl.asl.impl.StmtIFImpl#getTk_else <em>Tk else</em>}</li>
 *   <li>{@link jasonide.xtext.asl.asl.impl.StmtIFImpl#getPlan_term2 <em>Plan term2</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StmtIFImpl extends MinimalEObjectImpl.Container implements StmtIF
{
  ...
  public NotificationChain basicSetLog_expr(Log_expr newLog_expr, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AslPackage.STMT_IF__LOG_EXPR, oldLog_expr, newLog_expr);
  ...
  public void setLog_expr(Log_expr newLog_expr)
  {
    if (newLog_expr != log_expr)
    {
      ...
      if (log_expr != null)
        msgs = ((InternalEObject)log_expr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AslPackage.STMT_IF__LOG_EXPR, null, msgs);
      if (newLog_expr != null)
        msgs = ((InternalEObject)newLog_expr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AslPackage.STMT_IF__LOG_EXPR, null, msgs);
      msgs = basicSetLog_expr(newLog_expr, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AslPackage.STMT_IF__LOG_EXPR, newLog_expr, newLog_expr));
  }
  ...
  public NotificationChain basicSetPlan_term(Plan_term newPlan_term, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AslPackage.STMT_IF__PLAN_TERM, oldPlan_term, newPlan_term);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setPlan_term(Plan_term newPlan_term)
  {
    if (newPlan_term != plan_term)
    {
      NotificationChain msgs = null;
      if (plan_term != null)
        msgs = ((InternalEObject)plan_term).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AslPackage.STMT_IF__PLAN_TERM, null, msgs);
      if (newPlan_term != null)
        msgs = ((InternalEObject)newPlan_term).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AslPackage.STMT_IF__PLAN_TERM, null, msgs);
      msgs = basicSetPlan_term(newPlan_term, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AslPackage.STMT_IF__PLAN_TERM, newPlan_term, newPlan_term));
  }
  ...
  public void setTk_else(String newTk_else)
  {
    ...
    tk_else = newTk_else;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AslPackage.STMT_IF__TK_ELSE, oldTk_else, tk_else));
  }
  ...
  public NotificationChain basicSetPlan_term2(Plan_term newPlan_term2, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AslPackage.STMT_IF__PLAN_TERM2, oldPlan_term2, newPlan_term2);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setPlan_term2(Plan_term newPlan_term2)
  {
    if (newPlan_term2 != plan_term2)
    {
      NotificationChain msgs = null;
      if (plan_term2 != null)
        msgs = ((InternalEObject)plan_term2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AslPackage.STMT_IF__PLAN_TERM2, null, msgs);
      if (newPlan_term2 != null)
        msgs = ((InternalEObject)newPlan_term2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AslPackage.STMT_IF__PLAN_TERM2, null, msgs);
      msgs = basicSetPlan_term2(newPlan_term2, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AslPackage.STMT_IF__PLAN_TERM2, newPlan_term2, newPlan_term2));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AslPackage.STMT_IF__LOG_EXPR:
        return basicSetLog_expr(null, msgs);
      case AslPackage.STMT_IF__PLAN_TERM:
        return basicSetPlan_term(null, msgs);
      case AslPackage.STMT_IF__PLAN_TERM2:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case AslPackage.STMT_IF__PLAN_TERM:
        return getPlan_term();
      case AslPackage.STMT_IF__TK_ELSE:
        return getTk_else();
      case AslPackage.STMT_IF__PLAN_TERM2:
