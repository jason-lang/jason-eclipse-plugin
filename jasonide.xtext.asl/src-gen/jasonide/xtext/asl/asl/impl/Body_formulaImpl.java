 ...
 * <ul>
 *   <li>{@link jasonide.xtext.asl.asl.impl.Body_formulaImpl#getPlan_term <em>Plan term</em>}</li>
...
public class Body_formulaImpl extends MinimalEObjectImpl.Container implements Body_formula
{
  ...
  public NotificationChain basicSetPlan_term(Plan_term newPlan_term, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AslPackage.BODY_FORMULA__PLAN_TERM, oldPlan_term, newPlan_term);
  ...
  public void setPlan_term(Plan_term newPlan_term)
  {
    if (newPlan_term != plan_term)
    {
      ...
      if (plan_term != null)
        msgs = ((InternalEObject)plan_term).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AslPackage.BODY_FORMULA__PLAN_TERM, null, msgs);
      if (newPlan_term != null)
        msgs = ((InternalEObject)newPlan_term).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AslPackage.BODY_FORMULA__PLAN_TERM, null, msgs);
      msgs = basicSetPlan_term(newPlan_term, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AslPackage.BODY_FORMULA__PLAN_TERM, newPlan_term, newPlan_term));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AslPackage.BODY_FORMULA__PLAN_TERM:
