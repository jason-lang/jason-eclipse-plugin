...
public class AslPackageImpl extends EPackageImpl implements AslPackage
{
   ...
   * @generated
   */
  private EClass stmtIFCommonEClass = null;
  ...
  public static AslPackage init()
  {
    ...
    Object registeredAslPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    AslPackageImpl theAslPackage = registeredAslPackage instanceof AslPackageImpl ? (AslPackageImpl)registeredAslPackage : new AslPackageImpl();
   ...
   */
  @Override
  public EReference getPlan_Literal()
  {
   ...
   */
  @Override
  public EReference getPlan_List()
  {
   ...
   */
  @Override
  public EReference getStmtIF_StmtIFCommon()
  {
   ...
   */
  @Override
  public EClass getStmtIFCommon()
  {
    return stmtIFCommonEClass;
  }
   ...
   */
  @Override
  public EReference getStmtIFCommon_Log_expr()
  {
    return (EReference)stmtIFCommonEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getStmtIFCommon_Plan_term()
  {
    return (EReference)stmtIFCommonEClass.getEStructuralFeatures().get(1);
  }
   ...
   */
  @Override
  public EAttribute getStmtIFCommon_Tk_elif()
  {
    return (EAttribute)stmtIFCommonEClass.getEStructuralFeatures().get(2);
  }
   ...
   */
  @Override
  public EReference getStmtIFCommon_StmtIFCommon()
  {
    return (EReference)stmtIFCommonEClass.getEStructuralFeatures().get(3);
  }
   ...
   */
  @Override
  public EAttribute getStmtIFCommon_Tk_else()
  {
    return (EAttribute)stmtIFCommonEClass.getEStructuralFeatures().get(4);
  }
   ...
   */
  @Override
  public EReference getStmtIFCommon_Plan_term2()
  {
    return (EReference)stmtIFCommonEClass.getEStructuralFeatures().get(5);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(planEClass, PLAN__LITERAL);
    createEReference(planEClass, PLAN__LIST);
    ...
    createEReference(stmtIFEClass, STMT_IF__STMT_IF_COMMON);

    stmtIFCommonEClass = createEClass(STMT_IF_COMMON);
    createEReference(stmtIFCommonEClass, STMT_IF_COMMON__LOG_EXPR);
    createEReference(stmtIFCommonEClass, STMT_IF_COMMON__PLAN_TERM);
    createEAttribute(stmtIFCommonEClass, STMT_IF_COMMON__TK_ELIF);
    createEReference(stmtIFCommonEClass, STMT_IF_COMMON__STMT_IF_COMMON);
    createEAttribute(stmtIFCommonEClass, STMT_IF_COMMON__TK_ELSE);
    createEReference(stmtIFCommonEClass, STMT_IF_COMMON__PLAN_TERM2);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getPlan_Literal(), this.getLiteral(), null, "literal", null, 0, 1, Plan.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getPlan_List(), this.getList(), null, "list", null, 0, 1, Plan.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getStmtIF_StmtIFCommon(), this.getStmtIFCommon(), null, "stmtIFCommon", null, 0, 1, StmtIF.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(stmtIFCommonEClass, StmtIFCommon.class, "StmtIFCommon", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getStmtIFCommon_Log_expr(), this.getLog_expr(), null, "log_expr", null, 0, 1, StmtIFCommon.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getStmtIFCommon_Plan_term(), this.getPlan_term(), null, "plan_term", null, 0, 1, StmtIFCommon.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getStmtIFCommon_Tk_elif(), ecorePackage.getEString(), "tk_elif", null, 0, 1, StmtIFCommon.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getStmtIFCommon_StmtIFCommon(), this.getStmtIFCommon(), null, "stmtIFCommon", null, 0, 1, StmtIFCommon.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getStmtIFCommon_Tk_else(), ecorePackage.getEString(), "tk_else", null, 0, 1, StmtIFCommon.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getStmtIFCommon_Plan_term2(), this.getPlan_term(), null, "plan_term2", null, 0, 1, StmtIFCommon.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
