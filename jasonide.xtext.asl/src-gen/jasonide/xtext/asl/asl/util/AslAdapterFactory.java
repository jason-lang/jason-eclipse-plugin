...
public class AslAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected AslSwitch<Adapter> modelSwitch =
    new AslSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter casePlan_body_term(Plan_body_term object)
      {
        return createPlan_body_termAdapter();
      }
      @Override
      public Adapter casePlan_body_factor(Plan_body_factor object)
      {
        return createPlan_body_factorAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link jasonide.xtext.asl.asl.Plan_body_term <em>Plan body term</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createPlan_body_termAdapter()
  {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link jasonide.xtext.asl.asl.Plan_body_factor <em>Plan body factor</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createPlan_body_factorAdapter()
  {
    return null;
  }
