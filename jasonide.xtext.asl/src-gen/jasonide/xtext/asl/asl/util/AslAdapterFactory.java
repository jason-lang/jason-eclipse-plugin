...
public class AslAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected AslSwitch<Adapter> modelSwitch =
    new AslSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseStmtIFCommon(StmtIFCommon object)
      {
        return createStmtIFCommonAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link jasonide.xtext.asl.asl.StmtIFCommon <em>Stmt IF Common</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createStmtIFCommonAdapter()
  {
    return null;
  }
