...
public class AslSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        Plan_body_term plan_body_term = (Plan_body_term)theEObject;
        T result = casePlan_body_term(plan_body_term);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case AslPackage.PLAN_BODY_FACTOR:
      {
        Plan_body_factor plan_body_factor = (Plan_body_factor)theEObject;
        T result = casePlan_body_factor(plan_body_factor);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Plan body term</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Plan body term</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T casePlan_body_term(Plan_body_term object)
  {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>Plan body factor</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Plan body factor</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T casePlan_body_factor(Plan_body_factor object)
  {
    return null;
  }
