...
public interface AslFactory extends EFactory
{
  ...
  /**
   * Returns a new object of class '<em>Plan body term</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Plan body term</em>'.
   * @generated
   */
  Plan_body_term createPlan_body_term();

  /**
   * Returns a new object of class '<em>Plan body factor</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Plan body factor</em>'.
   * @generated
   */
  Plan_body_factor createPlan_body_factor();
