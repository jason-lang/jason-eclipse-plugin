 ...
 * <ul>
 *   <li>{@link jasonide.xtext.asl.asl.Literal#getAtom <em>Atom</em>}</li>
 *   <li>{@link jasonide.xtext.asl.asl.Literal#getVar <em>Var</em>}</li>
 ...
 *   <li>{@link jasonide.xtext.asl.asl.Literal#getVar2 <em>Var2</em>}</li>
...
public interface Literal extends EObject
{
   ...
   * @see #setAtom(String)
   * @see jasonide.xtext.asl.asl.AslPackage#getLiteral_Atom()
   * @model
   * @generated
   */
  String getAtom();
  ...
  /**
   * Sets the value of the '{@link jasonide.xtext.asl.asl.Literal#getAtom <em>Atom</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setVar(Var)
   * @see jasonide.xtext.asl.asl.AslPackage#getLiteral_Var()
  ...
  /**
   * Sets the value of the '{@link jasonide.xtext.asl.asl.Literal#getVar <em>Var</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setVar2(Var)
   * @see jasonide.xtext.asl.asl.AslPackage#getLiteral_Var2()
   * @model containment="true"
   * @generated
   */
  Var getVar2();
  ...
  /**
   * Sets the value of the '{@link jasonide.xtext.asl.asl.Literal#getVar2 <em>Var2</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
