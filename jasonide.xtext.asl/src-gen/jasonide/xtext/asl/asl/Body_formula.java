...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Body formula</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link jasonide.xtext.asl.asl.Body_formula#getPlan_term <em>Plan term</em>}</li>
 *   <li>{@link jasonide.xtext.asl.asl.Body_formula#getLog_expr <em>Log expr</em>}</li>
 * </ul>
 * </p>
 *
 * @see jasonide.xtext.asl.asl.AslPackage#getBody_formula()
 * @model
 * @generated
 */
public interface Body_formula extends EObject
{
  /**
   ...
   * @see jasonide.xtext.asl.asl.AslPackage#getBody_formula_Plan_term()
  ...
  /**
   * Sets the value of the '{@link jasonide.xtext.asl.asl.Body_formula#getPlan_term <em>Plan term</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see jasonide.xtext.asl.asl.AslPackage#getBody_formula_Log_expr()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link jasonide.xtext.asl.asl.Body_formula#getLog_expr <em>Log expr</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
