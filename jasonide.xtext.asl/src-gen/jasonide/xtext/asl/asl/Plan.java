 ...
 *   <li>{@link jasonide.xtext.asl.asl.Plan#getPred <em>Pred</em>}</li>
...
public interface Plan extends EObject
{
   ...
   * @see #setPred(Pred)
   * @see jasonide.xtext.asl.asl.AslPackage#getPlan_Pred()
  ...
  /**
   * Sets the value of the '{@link jasonide.xtext.asl.asl.Plan#getPred <em>Pred</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
