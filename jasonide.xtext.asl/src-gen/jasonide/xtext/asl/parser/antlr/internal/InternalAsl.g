...
// Entry rule entryRuleStmtIFCommon
entryRuleStmtIFCommon returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getStmtIFCommonRule()); }
	iv_ruleStmtIFCommon=ruleStmtIFCommon
	{ $current=$iv_ruleStmtIFCommon.current; }
	EOF;

// Rule StmtIFCommon
ruleStmtIFCommon returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleTK_REL_OP returns [String current=null]@init {
...
entryRuleNumber returns [EObject current=null]@init {
	HiddenTokens myHiddenTokenState = ((XtextTokenStream)input).setHiddenTokens();
}:
...
entryRuleJASON_ATOM returns [String current=null]@init {
	HiddenTokens myHiddenTokenState = ((XtextTokenStream)input).setHiddenTokens();
}:
...
@after {
	...
	(
		(
		    ...
		    |
		this_ATOMAPOST_2=RULE_ATOMAPOST
		{
...
// Entry rule entryRuleTK_ELIF
entryRuleTK_ELIF returns [String current=null]:
	{ newCompositeNode(grammarAccess.getTK_ELIFRule()); }
	iv_ruleTK_ELIF=ruleTK_ELIF
	{ $current=$iv_ruleTK_ELIF.current.getText(); }
	EOF;

// Rule TK_ELIF
ruleTK_ELIF returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
