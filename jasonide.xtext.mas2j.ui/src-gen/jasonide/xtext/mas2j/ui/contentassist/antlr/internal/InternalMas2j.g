...
{ before(grammarAccess.getBeliefsAccess().getValSTRINGTerminalRuleCall_2_0()); }
	RULE_STRING{ after(grammarAccess.getBeliefsAccess().getValSTRINGTerminalRuleCall_2_0()); }
)
...
{ before(grammarAccess.getGoalsAccess().getValSTRINGTerminalRuleCall_2_0()); }
	RULE_STRING{ after(grammarAccess.getGoalsAccess().getValSTRINGTerminalRuleCall_2_0()); }
)
...
{ before(grammarAccess.getMindinspectorAccess().getValSTRINGTerminalRuleCall_2_0()); }
	RULE_STRING{ after(grammarAccess.getMindinspectorAccess().getValSTRINGTerminalRuleCall_2_0()); }
)
