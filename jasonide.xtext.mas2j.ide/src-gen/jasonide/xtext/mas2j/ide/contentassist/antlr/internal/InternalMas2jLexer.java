...
public class InternalMas2jLexer extends Lexer {
    ...
    public final void mRULE_ID_WITH_STARTING_LCLETTER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMas2j.g:5328:32: ( ( '^' )? ( RULE_LCLETTER | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalMas2j.g:5328:34: ( '^' )? ( RULE_LCLETTER | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalMas2j.g:5328:34: ( '^' )?
            int alt1=2;
            ...
            // InternalMas2j.g:5328:59: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_ID_WITH_STARTING_UCLETTER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMas2j.g:5330:32: ( ( '^' )? ( RULE_UCLETTER | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalMas2j.g:5330:34: ( '^' )? ( RULE_UCLETTER | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalMas2j.g:5330:34: ( '^' )?
            int alt3=2;
            ...
            // InternalMas2j.g:5330:59: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_LCLETTER() throws RecognitionException {
        try {
            // InternalMas2j.g:5332:24: ( 'a' .. 'z' )
            // InternalMas2j.g:5332:26: 'a' .. 'z'
            {
            matchRange('a','z'); 
    ...
    public final void mRULE_UCLETTER() throws RecognitionException {
        try {
            // InternalMas2j.g:5334:24: ( 'A' .. 'Z' )
            // InternalMas2j.g:5334:26: 'A' .. 'Z'
            {
            matchRange('A','Z'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMas2j.g:5336:13: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' )
            // InternalMas2j.g:5336:15: '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
            {
            match('\"'); 
            // InternalMas2j.g:5336:19: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )*
            loop5:
            do {
                int alt5=3;
                ...
                switch (alt5) {
            	case 1 :
            	    // InternalMas2j.g:5336:20: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' )
            	    {
            	    match('\\'); 
    ...
    public final void mRULE_INT_LITERAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMas2j.g:5338:18: ( RULE_INTEGERNUMBER )
            // InternalMas2j.g:5338:20: RULE_INTEGERNUMBER
            {
            mRULE_INTEGERNUMBER(); 
    ...
    public final void mRULE_INTEGERNUMBER() throws RecognitionException {
        try {
            // InternalMas2j.g:5340:29: ( ( '0' | '1' .. '9' ( '0' .. '9' )* | '0' ( '0' .. '7' )+ | RULE_HEXPREFIX ( RULE_HEXDIGIT )+ ) )
            // InternalMas2j.g:5340:31: ( '0' | '1' .. '9' ( '0' .. '9' )* | '0' ( '0' .. '7' )+ | RULE_HEXPREFIX ( RULE_HEXDIGIT )+ )
            {
            // InternalMas2j.g:5340:31: ( '0' | '1' .. '9' ( '0' .. '9' )* | '0' ( '0' .. '7' )+ | RULE_HEXPREFIX ( RULE_HEXDIGIT )+ )
            int alt9=4;
            ...
            switch (alt9) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // InternalMas2j.g:5340:36: '1' .. '9' ( '0' .. '9' )*
                    {
                    matchRange('1','9'); 
                    // InternalMas2j.g:5340:45: ( '0' .. '9' )*
                    loop6:
                    do {
                        int alt6=2;
                    ...
                    break;
                case 3 :
                    // InternalMas2j.g:5340:57: '0' ( '0' .. '7' )+
                    {
                    match('0'); 
                    // InternalMas2j.g:5340:61: ( '0' .. '7' )+
                    int cnt7=0;
                    loop7:
                    do {
                        int alt7=2;
                    ...
                    break;
                case 4 :
                    // InternalMas2j.g:5340:73: RULE_HEXPREFIX ( RULE_HEXDIGIT )+
                    {
                    mRULE_HEXPREFIX(); 
                    // InternalMas2j.g:5340:88: ( RULE_HEXDIGIT )+
                    int cnt8=0;
                    loop8:
                    do {
                        int alt8=2;
    ...
    public final void mRULE_HEXPREFIX() throws RecognitionException {
        try {
            // InternalMas2j.g:5342:25: ( ( '0x' | '0X' ) )
            // InternalMas2j.g:5342:27: ( '0x' | '0X' )
            {
            // InternalMas2j.g:5342:27: ( '0x' | '0X' )
            int alt10=2;
    ...
    public final void mRULE_HEXDIGIT() throws RecognitionException {
        try {
            // InternalMas2j.g:5344:24: ( ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) )
            // InternalMas2j.g:5344:26: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )
            {
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMas2j.g:5346:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalMas2j.g:5346:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalMas2j.g:5346:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt11=0;
            loop11:
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMas2j.g:5348:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalMas2j.g:5348:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalMas2j.g:5348:24: ( options {greedy=false; } : . )*
            loop12:
            do {
                int alt12=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMas2j.g:5350:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalMas2j.g:5350:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalMas2j.g:5350:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop13:
            do {
                int alt13=2;
    ...
    static final String[] DFA16_transitionS = {
            "\2\40\2\uffff\1\40\22\uffff\1\40\1\uffff\1\36\1\31\4\uffff\1\16\1\17\2\uffff\1\15\1\uffff\1\4\1\41\12\37\1\6\1\12\1\uffff\1\21\3\uffff\14\35\1\1\15\35\1\13\1\uffff\1\14\1\32\1\33\1\uffff\1\10\1\26\1\11\1\20\1\7\1\34\1\27\1\34\1\5\3\34\1\30\1\24\3\34\1\22\1\23\2\34\1\25\4\34\1\2\1\uffff\1\3",
            "\1\42",
            "",
            "",
            "",
